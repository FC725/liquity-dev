...
const getSecret = (secretKey, defaultValue='') => {
    ...
    if (fs.existsSync(SECRETS_FILE)) {
        ...
        console.log(`SECRETS_FILE ${secrets}`)
...
const alchemUrlFantom = () => {
    return `https://eth-fantom.alchemyapi.io/v2/${getSecret('alchemyAPIKeyRinkeby')}`
}
...
module.exports = {
    ...
    networks: {
        ...
        fantom: {
            ...
            chainId : 4002,
            gas: 10000000,  // tx gas limit
            accounts : [getSecret('FANTOM_DEPLOYER_PRIVATEKEY', '0x60ddfe7f579ab6867cbe7a2dc03853dc141d7a4ab6dbefc0dae2d2b1bd4e487f')]
        }
    },
    etherscan: {
